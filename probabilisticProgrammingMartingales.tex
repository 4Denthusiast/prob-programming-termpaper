...
Take, for example, $M = \lambda x \, y. y \, (\tif{x < 0}{y \, (\underline f (x))}{\underline 3})$ and $P =\lambda ; \lambda ; @_2 ; \textsf{if}_2 ; @_2$, then 
\[
