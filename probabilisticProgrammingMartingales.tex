...
\lo{Given a (super)martingale $(Y_n)_{n \in \omega}$ and an a.s.~finite stopping time $T$ (meaning: for some $n \in \omega$, $T \leq n$ a.s.) both adapted to the same filtration, there exist supermartingale $(Y_n')_{n \in \omega}$ and antitone function $\epsilon$ such that $(Y_n')_{n \in \omega}$ is an antitone strict supermartingale w.r.t.~$(\epsilon, T)$.}
