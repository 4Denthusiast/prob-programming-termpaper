...
The injection $L_0(N) \to L_0(M)$ is trivial to define by appending $M \to N$ to each path, and using Lemma~\ref{lem:sim-M-N}, this induces a corresponding injection on the quotient, $L(N) \to L(M)$. 
