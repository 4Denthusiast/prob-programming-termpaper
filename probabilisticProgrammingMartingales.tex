...
\begin{enumerate}
\item (AST Soundness) If a closed SPCF term $M$ is antitone-convex rankable, then $T^{\tY}_M < \infty$ a.s.~(equivalently $M$ is AST), and $\expect{T^{\tY}_M} < \infty$. \lo{This should be fine.}
