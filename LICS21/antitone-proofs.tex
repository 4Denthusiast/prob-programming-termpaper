...
\subsection*{\Cref{ex:Fair-in-the-limit random walk} (Fair-in-the-limit random walk)}
\[
\underbrace{\big
(\tY \, \lambda f x .\ 
...
There is an obvious source of deterministic (i.e.~non-random) higher-order functions defined by recursion, viz., \emph{higher-order recursion schemes} (HORS) (see e.g.~\cite{DBLP:conf/lics/Ong06,DBLP:conf/lics/Ong15}).
