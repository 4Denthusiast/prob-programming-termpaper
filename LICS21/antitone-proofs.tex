...
\subsection*{\Cref{ex:raven complex}}
...
\subsection*{\Cref{ex:Fair-in-the-limit random walk}}
\[
\underbrace{\big
(\tY \, \lambda f x .\ 
...
\subsection*{\Cref{ex:non-affine recursion easy}}
Let 
\[
...
\subsection*{\Cref{ex:higher-order recursion}}
