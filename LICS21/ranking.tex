...
Not only is this counterexample AST, it's postively almost sure terminating (PAST). %positively almost surely terminating i.e.~the expected time to termination is finite.
