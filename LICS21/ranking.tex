...
\changed[akr]{Despite its simplicity, its $Rch$ contains all the terms in \Cref{fig:geometric distribution}.}
...
\lo{The graph can be simplified if we redefine general recursion using a fixpoint operator as per \Cref{eq:letrec redex}.
