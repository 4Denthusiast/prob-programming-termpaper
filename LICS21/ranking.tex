...
\changed[lo]{(The meaning of the substitution (which is to be applied to the contractum) and predicate that label some of the arrows in \Cref{fig:geometric distribution} should be self-explanatory.)}
