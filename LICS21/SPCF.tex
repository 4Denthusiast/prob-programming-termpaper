...
%\paragraph{}
The requirement that $M$ be closed is not important for the proofs of the theorems, but is simply needed to ensure that $M$ reaches a value, rather than a general normal form like $x \, y$.

%\paragraph{}
\begin{remark}
\label{rem:score}
This definition of almost sure termination is equivalent to that given in \cite{MakOPW21} (although the program semantics is stated in a slightly different way), except for the presence of a $\tscore(r)$ construct for soft conditioning. 
