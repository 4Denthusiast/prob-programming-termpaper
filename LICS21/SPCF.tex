...
The language PPCF is a simply-typed lambda calculus with sampling of real numbers from the closed interval $[0,1]$, \changed[lo]{following \cite{MakOPW21} except the score function (\Cref{rem:score})}. 
