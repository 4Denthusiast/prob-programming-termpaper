...
\changed[akr]{Note that antitone ranking functions are actually a generalisation of ranking functions, even though their name may suggest that they are a type of ranking functions.}
