...
Now
\[
g_2(n) - \frac{g_2(n-1) + g_2(n+1)} 2  >  \frac 1 2 \frac 1 {(n+1)^2} + \frac 1 2 \frac 1 {(n+3)^2}
\]
...
\paragraph*{More challenging examples} All of the following examples also have antitone ranking functions, provided in \cite{arxiv}.
