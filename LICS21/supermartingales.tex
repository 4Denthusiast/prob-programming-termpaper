...
\begin{remark}
Our notion of ranking supermartingale is a minor generalisation of the original definition, due to \cite{DBLP:conf/cav/ChakarovS13,DBLP:conf/popl/FioritiH15}, which does not refer to a stopping time explicitly.
