...
%\emph{Notation.}
\changed[lo]{Henceforth, fix the probability space $(\entrosp, \calF, \mu_{\entrosp})$, and a closed SPCF term $M$.
...
Define random variables on the probability space $(\entrosp, \calF, \mu)$:
\begin{align}
T_{-1}(s) & := -1 \nonumber \\
