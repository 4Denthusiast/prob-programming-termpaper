...
The random variable $T_M^\tY$, which we call the $\tY$-\defn{runtime} of $M$, can equivalently be defined as the number of $\tY$-reduction steps in the reduction sequence of $M$. 
