...
In recent unpublished work (under double-blind review elsewhere), the AST problem for higher-order programs with continuous distributions (and suitable primitive functions) is shown to have the same complexity.
