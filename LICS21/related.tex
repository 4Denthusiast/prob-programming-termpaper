...
\subsection*{Further directions} We have not yet been able to prove Conjecture~\ref{conj:antitone} which would imply that Theorem~\ref{thm:antitone rankable implies termination} is almost complete.
