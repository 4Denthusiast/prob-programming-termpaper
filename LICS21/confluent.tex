...
\pagebreak %Shift how things align to avoid a page break at a really bad location in defn:sim.
...
\end{align*}
In each of these cases, $M \mid \alpha$ is the \defn{redex}, and the reduction \defn{takes place at $\alpha$}. Each subterm can be a redex in at most one way, but there can be multiple redexes at different positions.
\end{definition}
...
\medskip %Shift how things align to avoid a page break at a really bad location in defn:sim.
