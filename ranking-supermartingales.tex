...
$(Y_n)_{n \in \omega}$ is a \emph{ranking} supermartingale if $Y_n \geq 0$, and there exists $\epsilon > 0$ such that $\expect{Y_{n+1} \mid \calF_n} \leq Y_n - \epsilon \cdot 1_{\set{Y_n > 0}}$.}
